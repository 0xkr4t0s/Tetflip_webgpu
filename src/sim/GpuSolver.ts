...
export class GpuSolver {
  ...
  private createKernels(): void {
    ...
    for (const name of ['p2g', 'nodeGather', 'tetGather', 'forces', 'assemble', 'prepareSolve', 'reduce0', 'reduce1', 'reduce2', 'pcgDirection', 'project', 'tetToNodes', 'g2p', 'advect', 'locate'])
